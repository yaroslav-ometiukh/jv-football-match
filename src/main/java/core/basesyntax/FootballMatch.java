...
public class FootballMatch {
    ...
    public int matchResult(int result1, int result2, int bet1, int bet2) {
        return (result1 == bet1 && result2 == bet2) ? 2 : (((result1 == result2 && bet1 != bet2) || (result1 > result2 && bet1 <= bet2) || (result1 < result2 && bet1 >= bet2)) ? 0 : 1);
    }
    /*
      boolean isWinnerBet = result1 == bet1 && result2 == bet2;
      boolean isLooseBet = (result1 == result2 && bet1 != bet2) || (result1 > result2 && bet1 <= bet2) || (result1 < result2 && bet1 >= bet2);
      return isWinnerBet ? 2 : (isLooseBet ? 0 : 1);
     */
}
